...
System.out.println("Sending frame " + seqNumber + ": " + frame);boolean ackReceived = false;
while (!ackReceived) {
String transmittedFrame = simulateChannel(frame);
if (transmittedFrame != null) {
System.out.println("Receiver got frame " + seqNumber + " as: " +transmittedFrame);
if (transmittedFrame.equals("ACK " + seqNumber)) {ackReceived = true;
...
System.out.println("Receiver received corrupted frame " + seqNumber + ": "+ frame);
